...
const Footer = () => {
  return (
    <div className="px-6 pt-16 mx-auto w-full md:px-24 lg:px-8 bg-card">
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-6 lg:max-w-sm">
            <p className="text-sm text-foreground">
              Discover the future of email outreach! Our app transforms the way
              you connect with key contacts, simplifying your hiring process by
              allowing seamless searches by company name.
            </p>
          </div>
        </div>
