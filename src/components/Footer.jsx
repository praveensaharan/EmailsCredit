...
const Footer = () => {
  return (
    ...
    <div className="px-4 pt-16 mx-auto w-full md:px-24 lg:px-8 bg-[#5d001e]">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          <Link
            ...
            aria-label="Go home"
            title="Company"
            className="inline-flex items-center bg-slate-50 p-3 rounded-xl font-bold text-customBlue"
          >
            <FaRegPaperPlane className="h-8 w-10 text-customGold animate-bounce" />
            <span className="text-lg">EmailsCredits</span>
          </Link>
          <div className="mt-6 lg:max-w-sm">
            <p className="text-sm text-[#e3e2df]">
              Discover the Future of Email Outreach! Our next-generation app
              transforms the way you find and connect with key contacts.
              Effortlessly search by company name to streamline your hiring
              process.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t border-[#e3afbc] lg:flex-row">
        <p className="text-sm text-[#e3e2df]">
          © Copyright 2024 EmailsCredits Inc. All rights reserved.
        </p>
