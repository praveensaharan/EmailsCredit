...
const CouponCard = () => {
  ...
  return (
    <div className="container mx-auto mt-14 flex flex-wrap justify-center gap-10 bg-gradient-to-br from-purple-600 to-indigo-600 p-10 rounded-lg shadow-xl">
      <div className="bg-gradient-to-br from-purple-600 to-indigo-600 text-white text-center py-10 px-6 sm:px-20 rounded-lg shadow-xl relative flex-grow max-w-md">
      ...
      <div className="bg-gradient-to-br from-green-400 to-blue-500 text-white text-center py-10 px-6 sm:px-20 rounded-lg shadow-xl relative flex-grow max-w-md">
        <h3 className="text-2xl font-semibold my-4">
