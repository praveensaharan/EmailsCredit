...
const Loader = () => {
  return (
    <div className="bg-background dark:bg-gray-800 flex justify-center items-center h-screen p-5 flex-col">
      <div className="border border-border p-2 rounded-md shadow-lg shadow-primary flex items-center gap-2 animate-pulse">
        <span className="text-6xl font-heading text-muted-foreground">L</span>
        <svg
        ...
        <span className="text-6xl font-heading text-muted-foreground">ad</span>
        <span className="text-6xl font-heading text-primary">ing..</span>
      </div>
      <p
        className="text-lg font-body text-foreground mt-2 px-2 items-center"
